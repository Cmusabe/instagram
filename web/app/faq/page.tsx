...
const FAQS = [
  ...
  { q: "Kan mijn account geblokkeerd worden?", a: "Instagram kan rate limiting toepassen bij veel automatische acties. Het script heeft ingebouwde pauzes om dit te voorkomen. Verhoog de vertraging als je toch geblokkeerd wordt. Een tijdelijke blokkade duurt meestal 30\u201360 minuten." },
  { q: "Hoe lang duurt het om alles te annuleren?", a: "Dat hangt af van het aantal accounts en je instellingen. Met standaard instellingen (2s delay, batches van 100): ~500 accounts per uur. Voor 4000 accounts is het ~2\u20133 uur." },
